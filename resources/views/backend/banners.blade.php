...
<a href="#banner" data-toggle="modal" class="btn btn-primary px-4">Add Banner</a>
    <div class="row">
      ...
      <div class="col-10 m-auto">
        <h3 class="mt-4">{{  $item->heading }} 

          <a class="mx-2" href="#bannerUp{{ $item->id }}" data-toggle="modal">Edit <i class="fas fa-edit"></i></a>

          <a href="{{ route('banner.destroy', $item->id) }}" onclick="event.preventDefault();
            document.getElementById('delete{{ $item->id }}').submit()"><i class="fas fa-trash-alt"></i></a>
      ...
      <div class="modal fade" id="bannerUp{{ $item->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="addNewAboutLabel" aria-hidden="true">
